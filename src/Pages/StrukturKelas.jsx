	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div className="flex flex-col justify-center items-center">
				...
				{/* Sekertaris */}
				<div className="flex justify-center relative top-[-3.8rem]" data-aos="fade-up" data-aos-duration="800">
					<div className="w-px h-12 bg-white"></div>
				</div>

				<div className="flex justify-center relative top-[-3.8rem]" data-aos="fade-up" data-aos-duration="1000">
					<img src="Circle.svg" alt="" />
				</div>

				<div
					className="flex justify-center relative top-[-3.8rem]"
					data-aos="fade-up"
